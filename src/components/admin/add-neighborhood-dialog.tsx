...
export function AddNeighborhoodDialog({ onNeighborhoodAdded }: AddNeighborhoodDialogProps) {
  ...
  async function onSubmit(values: FormData) {
    ...
    try {
      ...
      await addDoc(collection(db, 'neighborhoods'), neighborhoodData);
      ...
      toast({
        title: 'Error',
        description: 'Failed to add neighborhood. Please try again.',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new neighborhood option for group creation.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
